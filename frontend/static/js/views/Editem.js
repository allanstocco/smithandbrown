         ...
         <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
                <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
                    <div class="btn-toolbar mb-2 mb-md-0">
                        <a type="button" class="btn btn-sm btn-outline-secondary" href="/details/${items.id}" data-link>
                ...
                <div>
                    <form>
                        <div class="row g-3">
                            <div class="col-sm-3">
                                <label>Code</label>
                                <input type="text" class="form-control" value="${items.item_code}">
                            </div>
                            <div class="col-sm-9">
                                <label>Title</label>
                                <input type="text" class="form-control" value="${items.title}">
                            </div>
                        </div>
                        <div class="row g-3">
                            <div class="col-sm-12">
                                <label>Description</label>
                                <textarea type="text" rows="4" cols="50" class="form-control">${items.description}</textarea>
                            </div>
                        </div>
                        <div class="col-auto">
